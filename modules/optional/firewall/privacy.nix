...

{
  ...
  networking.nftables = {
    ...
    ruleset = ''
	  ...
	  ip saddr 192.168.0.9/32 accept
          
          iifname tun0 tcp dport 60053 accept
          iifname tun0 udp dport 60053 accept
        }
        ...
        chain forward {
          ...
          # Allow traffic from main0 bridge to the VPN interface (tun0)
          # This permits the container traffic to be forwarded. ➡️
          iifname main0 oifname tun0 accept;
          ...
          #iifname ens18 oifname main0 ip saddr 192.168.0.9 accept;
      ...
      table inet nat {
        chain prerouting {
          ...
          #iifname ens18 ip saddr 192.168.0.9 tcp dport 8080 dnat to 172.18.0.14:8080;
        }

        chain postrouting {
          type nat hook postrouting priority 100;
          
          iifname main0 oifname tun0 masquerade
